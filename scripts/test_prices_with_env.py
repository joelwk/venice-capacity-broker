    ...
    try:
        ...
        for sym, price in prices.items():
            ...
            if sym in ["VVV", "DIEM"] and price < 0.01:
                print(
                    f"      -> Suspicious! If this is base units (18 decimals), real price would be: ${price * 1e18:,.2f}"
                )
                print(
                    f"      -> If base units (6 decimals for USDC equivalent): ${price * 1e6:,.2f}"
                )
