...
class QuorumCoordinator:
    ...
    _last_context: QuorumContext | None = field(default=None, init=False, repr=False)
    ...
    @property
    def last_context(self) -> QuorumContext | None:
...
def build_default_coordinator(
    *,
    ...
    include_flag = (
        include_treasury
        if include_treasury is not None
        else _env_bool("QUORUM_INCLUDE_TREASURY", False)
    )
