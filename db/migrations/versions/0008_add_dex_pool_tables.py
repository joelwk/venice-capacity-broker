...
def upgrade() -> None:
    op.create_table(
        "dexfactorycursor",
        sa.Column(
            "factory_address", sa.String(length=66), primary_key=True, nullable=False
        ),
        sa.Column(
            "factory_type",
            sa.String(length=64),
            nullable=False,
            server_default="uniswap_v2",
        ),
    ...
    op.create_table(
        "dexpool",
        sa.Column(
            "pool_address", sa.String(length=66), primary_key=True, nullable=False
        ),
    ...
    op.create_index(
        "ix_dexfactorycursor_factory_type", "dexfactorycursor", ["factory_type"]
    )
