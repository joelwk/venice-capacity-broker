...
def test_recycle_profits_dry_run(monkeypatch):
    ...
    monkeypatch.setenv("STAKEMASTER_MIN_STAKE_USD", "0.5")  # Lower threshold for test
    ...
    usdc_wei = 1_000_000  # 1 USDC (6 decimals) - ensures > min_stake_usd
