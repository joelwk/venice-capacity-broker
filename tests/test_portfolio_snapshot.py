...
def test_portfolio_snapshot_computes_usd_valuation():
    ...
    with patch("services.portfolio.inventory.describe_treasury_portfolio", return_value=mock_snapshot):
        with patch("services.portfolio.inventory.MarketDataProvider") as mock_mdp:
