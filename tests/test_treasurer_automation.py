...
MIN_ACTION_USD_SMALL = "10.0"
MIN_ACTION_USD_LARGE = "100.0"
TOLERANCE = 1e-6
TARGET_BUFFER_MULTIPLIER = 1.5
...
def test_treasurer_execute_recycle_profits_dry_run():
    ...
    os.environ["TREASURER_ENABLE_AUTOMATION"] = "1"
    os.environ["TREASURER_MIN_ACTION_USD"] = MIN_ACTION_USD_SMALL
...
def test_treasurer_execute_skips_below_minimum():
    ...
    os.environ["TREASURER_ENABLE_AUTOMATION"] = "1"
    os.environ["TREASURER_MIN_ACTION_USD"] = MIN_ACTION_USD_LARGE
...
def test_treasurer_rebalance_computation():
    ...
    target = avg_daily * TARGET_BUFFER_MULTIPLIER  # 150.0
