...
from libs.agentkit_ext.actions import DIEMACTIONS
try:
...
class DIEMService:
    ...
    def trade(self, side: str, amount: int) -> Dict[str, Any]:
        ...
        if side_l == "buy":
            ...
            if hasattr(self.aggregator, "trade_best_exact_out"):
                try:
    ...
    def quote(self, side: str, amount: int) -> Dict[str, Any]:
        ...
        if side_l == "sell":
            ...
            if hasattr(self.aggregator, "quote_all_exact_out"):
