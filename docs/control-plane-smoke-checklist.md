...
5. Submit a known-good transaction hash, watch the spinner and info alert while verification runs, then confirm Step 3 appears with the success alert, key value, copy button, and expiry timestamp.
